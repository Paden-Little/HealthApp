...
// Returns the service ID generated for Consul
// Automatically generates Traefik tags, service id, and retrieves hostname
// Assumes the service has a health check at /health
// Autogenerated service ID is <service_name>-<uuid>
// Autogenerated tags:
// - traefik.enable=true
// - traefik.http.routers.<service_name>.rule=PathPrefix(`<service_path>`)
