  ...
  <form class="md mx-auto mt-28 max-w-screen-md">
    <div class="group relative z-0 mb-5 w-full">
      <input
        ...
        name="floating_email"
        id="floating_email"
        class="peer block w-full appearance-none border-0 border-b-2 border-gray-300 bg-transparent px-0 py-2.5 text-sm text-gray-900 focus:border-blue-600 focus:outline-none"
        placeholder=" "
        required
      />
      <label
